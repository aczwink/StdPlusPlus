...
namespace _stdxx_
{
	...
	public:
		//Constructor
		inline libavcodec_Encoder(const StdXX::BijectiveMap<StdXX::Multimedia::NamedPixelFormat, AVPixelFormat> &libavPixelFormatMap,
								  StdXX::Multimedia::CodingFormatId codingFormatId, AVCodecID libavCodecId)
