...
namespace StdXX
{
    namespace Rendering
    {
        ...
        class VectorPathRenderer
        {
        public:
            //Destructor
            virtual ~VectorPathRenderer() {}
            ...
            virtual void Fill() = 0;
            virtual void LineTo(const Math::Vector2D& pos) = 0;
            virtual void MoveTo(const Math::Vector2D& pos) = 0;
            ...
            inline void Rectangle(const Math::RectD& rect)
            {
                this->BeginPath();
                this->MoveTo(rect.x(), rect.y());
                this->LineTo(rect.GetHorizontalEnd(), rect.y());
                this->LineTo(rect.GetHorizontalEnd(), rect.GetVerticalEnd());
                this->LineTo(rect.x(), rect.GetVerticalEnd());
                this->ClosePath();
            }
