...
namespace StdXX
{
    ...
    STDPLUSPLUS_API ByteString operator+(const ByteString &left, const ByteString &right);
    STDPLUSPLUS_API bool operator==(const ByteString &left, const ByteString &right);
    STDPLUSPLUS_API bool operator!=(const ByteString &left, const ByteString &right);
    STDPLUSPLUS_API bool operator<(const ByteString &left, const ByteString &right);
    STDPLUSPLUS_API bool operator>(const ByteString &left, const ByteString &right);
}